...
# 至少提供 18 个中奖奖品，供前端转盘随机取 15 个 + 3~5 个"谢谢参与" = 18~20 扇区
DEMO_LOTTERY_PRIZES = [
    ("谢谢参与", "再接再厉，下次好运", 30, None, 0, 0),
    ("文具大礼包", "抽奖专属·实用文具套装", 10, 10, 1, 1),
    ("卡通雨伞", "晴雨两用·可爱造型", 8, 5, 1, 2),
    ("益智拼图", "300 片·锻炼思维", 6, 8, 1, 3),
    ("神秘大奖", "终极大奖·惊喜好礼", 3, 2, 1, 4),
    ("彩色蜡笔套装", "24 色安全蜡笔", 7, 6, 1, 5),
    ("故事绘本", "精装童话故事书", 6, 7, 1, 6),
    ("小夜灯", "可爱动物造型 LED 灯", 5, 5, 1, 7),
    ("笔记本礼盒", "创意手账本套装", 6, 8, 1, 8),
    ("钥匙扣挂件", "卡通人物钥匙链", 7, 15, 1, 9),
    ("贴纸包", "100 张精美贴纸", 8, 20, 1, 10),
    ("橡皮擦套装", "创意造型橡皮擦", 5, 12, 1, 11),
    ("彩色铅笔", "12 色优质彩色铅笔", 7, 10, 1, 12),
    ("橡皮泥套装", "24 色安全无毒橡皮泥", 6, 8, 1, 13),
    ("贴纸书", "趣味贴纸游戏书", 7, 10, 1, 14),
    ("小计算器", "学生专用计算器", 5, 6, 1, 15),
    ("书签套装", "金属创意书签 6 枚装", 6, 10, 1, 16),
    ("卡通水杯", "便携保温卡通水杯", 4, 5, 1, 17),
    ("迷你风扇", "USB 充电小风扇", 4, 5, 1, 18),
    ("拼图玩具", "木制益智拼图", 5, 6, 1, 19),
]
