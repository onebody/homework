...
独立的「打卡赚积分 → 积分兑换奖品 → 抽奖」功能模块。

- 技术栈：FastAPI + SQLAlchemy 2.0 + SQLite + 原生 HTML/JS
- 特点：无构建依赖、可独立运行、易于移植
- 功能：每日打卡、积分兑换抽奖券、加权随机抽奖、完整积分流水对账、奖品库存管理
...
- 默认账号：admin（首次启动自动生成随机密码，见控制台输出）
